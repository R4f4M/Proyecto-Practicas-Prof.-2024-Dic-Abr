...
?php
   ...
   class AjaxProcesos{
     ...
     public function ListTiendasTermindas(){

        $respuesta = ProcesosController::ctrListTiendasTerminadas();
...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Incremento de módulo coppel.com| Implementación</h1>
          </div>
          <div class="col-sm-6">
...
$PDO = $conexion;
$statement = $PDO->prepare("SELECT * FROM modulocoppel_com");
$statement->execute();
$modulocoppel_com=$statement->fetchAll();
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
<table id="modulocoppel_com" class="display">
    <thead>
        <tr>
            <th>id</th>
            <th>Nacional</th>
            ...
            <th>Sistemas IT</th>
            <th>Total Tiendas</th>
            <th>Total PCs a Instalar</th>
            <th>Total PCs Instaladas</th>
            <th>Tiendas Terminadas</th>
            <th>Porcentaje</th>
        </tr>
    </thead>
    <tbody>
        <?php foreach($modulocoppel_com as $moduloscoppel_com): ?>
        <tr>
            <td><?php echo $moduloscoppel_com[0] ?></td>
            <td><?php echo $moduloscoppel_com[1] ?></td>
            <td><?php echo $moduloscoppel_com[2] ?></td>
            <td><?php echo $moduloscoppel_com[3] ?></td>
            <td><?php echo $moduloscoppel_com[4] ?></td>
            <td><?php echo $moduloscoppel_com[5] ?></td>
            <td><?php echo $moduloscoppel_com[6] ?></td>
            <td><?php echo $moduloscoppel_com[7] ?></td>
            <td><?php echo $moduloscoppel_com[8] ?></td>
        </tr>
        <?php endforeach; ?>
    </tbody>
</table>
...
<div class="wrapper">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                ...
                <a href="http://localhost/adminlte/Proyectos/Desenergizacion/index.php" class="btn btn-primary">Sitio</a>
              </div>
            </div>
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                ...
                <a href="https://localhost/adminlte/Proyectos/Temporada/index.php" class="btn btn-primary">Sitio</a>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="#" class="card link">Toca Dashboard</a>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="p-3">
    <h5>Divisio de Tecnologia de Grupo Coppel</h5>
      <a href="https://sites.google.com/coppel.com/staff-it/sistemas/nacional-i?authuser=0" class="btn btn-primary">Nacionl I</a>
      <a href="https://sites.google.com/coppel.com/staff-it/sistemas/nacional-i?authuser=0" class="btn btn-primary">Nacionl II</a>
    </div>
  </aside>
  <!-- /.control-sidebar -->
...
class ProcesosController{
    ...
    static public function ctrListTiendasTerminadas(){

        $respuesta = ProcesosModelo::mdListTiendasTerminadas();
...
class ProcesosModelo{
    ...
    static public function mdListTiendasTerminadas(){
        $stmt = Conexion::conectar()->prepare("CALL prc_ListTiendasTerminadas");        
